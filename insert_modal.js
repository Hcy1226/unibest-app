...
// Insert before CustomTabBar
const searchStr = '    <CustomTabBar />';
if (content.includes(searchStr)) {
    content = content.replace(searchStr, modal + '\n' + searchStr);
    fs.writeFileSync(filePath, content, 'utf8');
    console.log('✓ Employee selector modal inserted successfully!');
} else {
    console.log('✗ Could not find CustomTabBar in the file');
}
